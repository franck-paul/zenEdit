...
class Uninstall extends dcNsProcess
{
    ...
    public static function process(): bool
    {
        ...
        // Database table name
        // $table = dcCore::app()->prefix . 'zenEdit';
        ...
        $user_actions = [
            ...
            'preferences' => [
                ...
                ['delete_related', 'interface:zenedit_fullscreen;interface:zenedit_background;interface:zenedit_small_margins'], // Delete specific preference(s)
            ],
